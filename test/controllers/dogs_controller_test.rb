...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { image_url: @dog.image_url, name: @dog.name, status: @dog.status } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { image_url: @dog.image_url, name: @dog.name, status: @dog.status } }, as: :json
    assert_response 200
  end
